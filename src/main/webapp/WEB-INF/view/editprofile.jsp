	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="well">
						<form:form modelAttribute="donor" class="form-horizontal" action="../profile" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input type="submit" id="btnAdd" class="btn btn-info btn-block" value="Register">
								<span class="help-block"></span>
								</div>								
							</div>
								<div>
							...
							<div class="col-lg-8">
									<form:input id="password" path="password" placeholder="Please enter Password" type="hidden" class="form-control" value=""/>
								<span class="help-block"></span>
								</div>
								<div>
							...
							<div class="col-lg-8">
									<form:input id="registrationDate" path="registrationDate" placeholder="Please enter Registration Date" type="hidden" class="form-control hasDatepicker" value=""/>
								<span class="help-block"></span>
								</div>	
						</form:form>
					</div>
